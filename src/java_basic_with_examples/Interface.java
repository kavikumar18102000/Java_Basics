...
class Hero_cycle implements Model{
	int speed;
...
public class Interface {
	...
	public static <GearCycle> void main(String[] args) {
		...
		GearCycle h2 = new Hero_cycle(); // this object is can only implement the methods present in the Bicycle interface...
